 ...
 */
static mlan_status wlan_uap_bss_ioctl_stop(
 ...
 */
static mlan_status wlan_uap_callback_bss_ioctl_start(
    IN t_void*    priv
    )
{
    mlan_status ret = MLAN_STATUS_SUCCESS;
 ...
 */
static mlan_status wlan_uap_bss_ioctl_start(
    IN pmlan_adapter    pmadapter,
    IN pmlan_ioctl_req  pioctl_req)
{
    mlan_status  ret = MLAN_STATUS_SUCCESS;
 ...
 *  @return		MLAN_STATUS_PENDING --success, otherwise fail
 */
static mlan_status wlan_uap_bss_ioctl_reset(
    IN pmlan_adapter    pmadapter,
    IN pmlan_ioctl_req  pioctl_req)
{
    mlan_status  ret = MLAN_STATUS_SUCCESS;
 ...
 *  @return		MLAN_STATUS_PENDING --success, otherwise fail
 */
static mlan_status wlan_uap_bss_ioctl_mac_address(
    IN pmlan_adapter    pmadapter,
    IN pmlan_ioctl_req  pioctl_req)
{
 ...
 *  @return		MLAN_STATUS_PENDING --success, otherwise fail
 */
static mlan_status wlan_uap_get_stats(
    IN pmlan_adapter    pmadapter,
    IN pmlan_ioctl_req  pioctl_req)
{
    mlan_status  ret = MLAN_STATUS_SUCCESS;
 ...
 *  @return		MLAN_STATUS_PENDING --success, otherwise fail
 */
static mlan_status wlan_uap_bss_ioctl_config(
    IN pmlan_adapter    pmadapter,
    IN pmlan_ioctl_req  pioctl_req)
{
    mlan_private    *pmpriv = pmadapter->priv[pioctl_req->bss_index];
 ...
 *  @return		MLAN_STATUS_PENDING --success, otherwise fail
 */
static mlan_status wlan_uap_bss_ioctl_deauth_sta(
    IN pmlan_adapter    pmadapter,
    IN pmlan_ioctl_req  pioctl_req)
{
    mlan_status  ret = MLAN_STATUS_SUCCESS;
 ...
 *  @return		MLAN_STATUS_PENDING --success, otherwise fail
 */
static mlan_status wlan_uap_get_sta_list(
    IN pmlan_adapter    pmadapter,
    IN pmlan_ioctl_req  pioctl_req)
{
    pmlan_private  pmpriv = pmadapter->priv[pioctl_req->bss_index];
 ...
 *  @return		MLAN_STATUS_PENDING --success, otherwise fail
 */
static mlan_status wlan_uap_misc_ioctl_soft_reset(
    IN pmlan_adapter    pmadapter,
    IN pmlan_ioctl_req  pioctl_req)
{
	mlan_private     *pmpriv = pmadapter->priv[pioctl_req->bss_index];
 ...
 *  @return		MLAN_STATUS_PENDING --success, otherwise fail
 */
static mlan_status wlan_uap_misc_ioctl_txdatapause(
    IN pmlan_adapter    pmadapter,
    IN pmlan_ioctl_req  pioctl_req)
{
	mlan_private     *pmpriv = pmadapter->priv[pioctl_req->bss_index];
 ...
 *  @return		MLAN_STATUS_PENDING --success, otherwise fail
 */
static mlan_status wlan_uap_pm_ioctl_mode(
    IN pmlan_adapter    pmadapter,
    IN pmlan_ioctl_req  pioctl_req)
{
    mlan_private   *pmpriv = pmadapter->priv[pioctl_req->bss_index];
 ...
 */
static mlan_status wlan_uap_misc_ioctl_gen_ie(
    IN pmlan_adapter    pmadapter,
    IN pmlan_ioctl_req  pioctl_req)
{
    mlan_status ret = MLAN_STATUS_SUCCESS;
 ...
 */
static mlan_status wlan_uap_sec_ioctl_wapi_enable(
    IN pmlan_adapter    pmadapter,
    IN pmlan_ioctl_req  pioctl_req)
{
    mlan_status ret = MLAN_STATUS_SUCCESS;
 ...
 *  @return		MLAN_STATUS_SUCCESS --success
 */
static mlan_status wlan_uap_get_bss_info(
    IN pmlan_adapter    pmadapter,
    IN pmlan_ioctl_req  pioctl_req)
{
    pmlan_private  pmpriv = pmadapter->priv[pioctl_req->bss_index];
 ...
 */
static mlan_status wlan_uap_pm_ioctl_deepsleep(
    IN pmlan_adapter    pmadapter,
    IN pmlan_ioctl_req  pioctl_req
    )
{
 ...
 *  @return     MLAN_STATUS_PENDING --success, otherwise fail
 */
static mlan_status wlan_uap_snmp_mib_11d(
    IN pmlan_adapter    pmadapter,
    IN pmlan_ioctl_req  pioctl_req
    )
{
 ...
 */
static mlan_status wlan_uap_callback_domain_info(
    IN t_void*    priv
    )
{
    mlan_status ret = MLAN_STATUS_SUCCESS;
 ...
 */
static mlan_status wlan_uap_domain_info(
    IN pmlan_adapter    pmadapter,
    IN pmlan_ioctl_req  pioctl_req
    )
{
 ...
 */
static mlan_status wlan_uap_callback_11h_channel_check_req(
    IN t_void*    priv
    )
{
 ...
 */
static mlan_status wlan_uap_11h_channel_check_req(
    IN pmlan_adapter    pmadapter,
    IN pmlan_ioctl_req  pioctl_req
    )
{
 ...
 */
static mlan_status wlan_uap_callback_snmp_mib_11h(
    IN t_void*    priv
    )
{
    mlan_status ret = MLAN_STATUS_SUCCESS;
    ...
    ret = wlan_11h_activate(pmpriv, (t_void*)puap_state_chan_cb->pioctl_req_curr,
                            enable_11h);
 ...
 */
static mlan_status wlan_uap_snmp_mib_11h(
    IN pmlan_adapter    pmadapter,
    IN pmlan_ioctl_req  pioctl_req
    )
{
 ...
 */
mlan_status wlan_uap_get_channel(
 ...
 *  @return         MLAN_STATUS_SUCCESS --success, otherwise fail
 */
mlan_status wlan_uap_set_channel(
    IN pmlan_private    pmpriv,
    IN t_u8             uap_band_cfg,
    IN t_u8             channel
    )
{
    MrvlIEtypes_channel_band_t tlv_chan_band;
 ...
 *  @return         MLAN_STATUS_SUCCESS --success, otherwise fail
 */
mlan_status wlan_uap_get_beacon_dtim(
    IN pmlan_private    pmpriv
    )
{
 ...
 *  @return		MLAN_STATUS_SUCCESS --success, otherwise fail
 */
mlan_status wlan_ops_uap_ioctl(
    t_void           *adapter,
