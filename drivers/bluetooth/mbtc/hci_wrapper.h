 ...
 */
static inline int mdev_recv_frame(struct sk_buff *skb)
{
 ...
 *  @return        0
 */
static inline int mbt_hci_suspend_dev(struct m_dev *m_dev)
{
	return 0;
}
 ...
 *  @return        0
 */
static inline int mbt_hci_resume_dev(struct m_dev *m_dev)
{
	return 0;
}
