...
static struct ina219_platform_data power_mon_info[] = {
	[VDD_12V_DCIN_RS] = {
		...
		.divisor = 20,
		.precision_multiplier = PRECISION_MULTIPLIER_MOLLY,
		.cont_conf = 0x3FFF,
		.trig_conf = 0x1DB,
		.shunt_resistor = 10,
	},
	...
	[VDD_AC_BAT_VIN1] = {
		...
		.power_lsb = 1.2500381481 * PRECISION_MULTIPLIER_MOLLY,
	...
	[VDD_5V0_SYS] = {
		.calibration_data  = 0xfffe,
		.power_lsb = 2.5000762963 * PRECISION_MULTIPLIER_MOLLY,
	...
	[VDD_AC_BAT_D1] = {
		...
		.power_lsb = 2.563685298 * PRECISION_MULTIPLIER_MOLLY,
