...
static struct dvfs core_dvfs_table[] = {
	...
	OVRRD_DVFS("sdmmc1",  0,  0, 1, KHZ,       1,  81600,  81600,  81600,   81600,  156000,  156000,  156000,  204000),
	OVRRD_DVFS("sdmmc3",  0,  0, 1, KHZ,       1,  81600,  81600,  81600,   81600,  156000,  156000,  156000,  204000),
	OVRRD_DVFS("sdmmc4",  0,  0, 1, KHZ,       1, 102000, 102000, 102000,  102000,  156000,  156000,  156000,  200000),

	OVRRD_DVFS("sdmmc1",  0,  1, 1, KHZ,       1,  81600,  81600,  81600,   81600,  156000,  204000,  204000,  204000),
	OVRRD_DVFS("sdmmc3",  0,  1, 1, KHZ,       1,  81600,  81600,  81600,   81600,  156000,  204000,  204000,  204000),
	OVRRD_DVFS("sdmmc4",  0,  1, 1, KHZ,       1, 102000, 102000, 102000,  102000,  156000,  200000,  200000,  200000),

	OVRRD_DVFS("sdmmc1",  1,  1, 1, KHZ,       1,  81600,  81600,  81600,   81600,  156000,  156000,  156000,  204000),
	OVRRD_DVFS("sdmmc3",  1,  1, 1, KHZ,       1,  81600,  81600,  81600,   81600,  156000,  156000,  156000,  204000),
	OVRRD_DVFS("sdmmc4",  1,  1, 1, KHZ,       1, 102000, 102000, 102000,  102000,  156000,  156000,  156000,  200000),
