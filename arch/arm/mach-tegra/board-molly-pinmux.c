...
static __initdata struct tegra_pingroup_config molly_pinmux_set_nontristate[] = {
...
int __init molly_pinmux_init(void)
{
	...
	tegra_pinmux_config_table(molly_pinmux_common, ARRAY_SIZE(molly_pinmux_common));
