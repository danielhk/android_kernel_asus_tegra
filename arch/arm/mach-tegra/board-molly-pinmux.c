/*
 * arch/arm/mach-tegra/board-molly-pinmux.c
 *
...
static __initdata struct tegra_drive_pingroup_config molly_drive_pinmux[] = {
...
static __initdata struct tegra_pingroup_config molly_pinmux_nontristate[] = {
...
static void __init molly_gpio_init_configure(void)
{
	...
	len = ARRAY_SIZE(init_gpio_mode_molly_common);
	pins_info = init_gpio_mode_molly_common;
...
{
	tegra_pinmux_config_table(molly_pinmux_nontristate,
				  ARRAY_SIZE(molly_pinmux_nontristate));
	molly_gpio_init_configure();

	tegra_pinmux_config_table(molly_pinmux_common,
				  ARRAY_SIZE(molly_pinmux_common));
	tegra_drive_pinmux_config_table(molly_drive_pinmux,
